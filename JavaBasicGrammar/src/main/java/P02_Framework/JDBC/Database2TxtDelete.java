 ...
 * @version : 1.0
 */
public class Database2TxtDelete {
    public static void main(String[] args) {
        new Database2TxtDelete().database2Txt("/Users/zwh/WorkSpace/IDEAWorkspace/JavaBasicStudyPro/JavaBasicGrammar/src/main/resources/a.txt");
    }
